...
%  Event display and setting  window of VFS (Video FluoroScopy) analyzer.
  ...
  methods
    ...
    function self = vfspEvent (theDocument)
      ...
      rowCount = size (self.document.app.pref_eventStrings, 1);
      data = cell (rowCount, 2);
      data (:, 1) = self.document.app.pref_eventStrings;
      for i = 1 : rowCount
        data (i, 2) = num2cell (self.document.eventFrames (i));
      end
  ...
  methods (Access = private)
    ...
    function cellSelected (self, src, event)
      ...
      if selectedCol == 1
        % self.document.eventFrames (selectedRow) = ...
        %   self.document.currentFrameIndex;
        
        % Display.
        self.eventTable.Data (selectedRow, 2) = ...
            num2cell (self.document.currentFrameIndex);
      end
    ...
    function closeDialog (self, src, event)
      eventCount = size (self.document.eventFrames, 1);
      
      for i = 1 : eventCount
        self.document.eventFrames (i) = ...
